      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-20 lg:pt-24 lg:pb-28">
        <div className="max-w-3xl">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-accent-500/25 bg-accent-500/10 text-xs text-accent-300 mb-6 animate-fade-in">
            ...
            AI-assisted security testing for small teams
          </div>
          ...
          <p className="mt-5 text-lg text-gray-400 leading-relaxed max-w-xl animate-fade-up" style={{ animationDelay: '0.1s' }}>
            Run an AI-assisted security test on your website in minutes. Start free. No credit card required.
          </p>
  ...
  return (
    <section id="how-it-works" className="py-20 lg:py-28 border-t border-ink-700/30">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <SectionHeading eyebrow="How It Works" title="Three steps to your security report" />
...
function WhatPentorChecks() {
  return (
    <section className="py-20 lg:py-28 border-t border-ink-700/30">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <SectionHeading
          eyebrow="What Pentor Checks"
          title="Clear categories, not an intimidating tool list"
          subtitle="Pentor examines your website across the areas that matter most for small-business security. The precise scope depends on your selected test."
        />
...
function SampleFindings() {
  return (
    <section className="py-20 lg:py-28 border-t border-ink-700/30">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <SectionHeading
          eyebrow="Sample Findings Preview"
          title="See what a Pentor report looks like"
          subtitle="This is a realistic preview using mock findings — not real results from an actual scan."
        />
        <Card raised className="overflow-hidden">
          <div className="p-5 border-b border-ink-700/50 flex items-center justify-between flex-wrap gap-3">
            <div>
              ...
              <h3 className="text-base font-semibold text-gray-100 mt-0.5">Security Report Preview</h3>
            </div>
    ...
    <section id="human-pentest" className="py-20 lg:py-28 border-t border-ink-700/30">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            <SectionHeading
              eyebrow="Human Pentest"
              title="Need a real human to think like an attacker?"
              subtitle="A vetted white-hat security specialist manually examines your authorized target and delivers a professional, validated report."
            />
            <ul className="space-y-3 mb-8">
              {[
                'Manual attack-path analysis',
                'Validated findings',
            ...
            <div className="mt-6 rounded-lg border border-accent-500/20 bg-accent-500/5 p-4 flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-accent-400 shrink-0 mt-0.5" />
              <p className="text-sm text-gray-400">
                Scope and authorization are confirmed before testing begins.
              </p>
            </div>
          </div>
          ...
          <Card raised className="p-6 lg:p-8">
            <div className="space-y-4">
              <div className="flex items-center gap-3 pb-4 border-b border-ink-700/40">
                ...
                <div>
                  <h3 className="text-base font-semibold text-gray-100">Manual white-hat assessment</h3>
                  <p className="text-xs text-gray-500">Vetted security specialists</p>
                </div>
              </div>
              <div className="space-y-3">
                {[
                  { label: 'Approach', value: 'Manual, attacker-mindset testing' },
                  { label: 'Validation', value: 'Every finding confirmed by a human' },
                  { label: 'Output', value: 'Professional PDF report with fix guidance' },
                  { label: 'Timeline', value: 'Scheduled after scope review' },
    ...
    <section className="py-20 lg:py-28 border-t border-ink-700/30">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-10 text-center">
          <p className="text-sm text-gray-500 mb-4">Ready to test your site?</p>
